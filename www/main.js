...
function getPhoneNumber() {
  const phone = localStorage.getItem("fake-number");
...
const History = {
   ...
   * @param {string} msg - Message from orderer to add to History
   * @param {string} from - Location message was created (user or server)
   */
   ...
   */
  get: function () {
    let pastMessages = localStorage.getItem("history");

    if (pastMessages) return JSON.parse(pastMessages);
    return false;
  },
};
